...
namespace rSysServer
{
    public abstract class HttpServer
    {
        ...
        public void Listen()
        {
            ...
            while (this.isActive)
            {
                TcpClient tc = this.listener.AcceptTcpClient();
        ...
        public abstract void HandleGETRequest(HttpProcessor httpProcessor);
        public abstract void HandlePOSTRequest(HttpProcessor httpProcessor, StreamReader inputData);
    }
}
